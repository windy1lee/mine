...
let config = {
    ...
    heweather_apiKey: "faead3de5f42420098c8132b3924cd09", //和风天气APIkey,可自行前往 https://dev.heweather.com/ 进行获取
...
function heweatherLifestyle() {
    ...
    if (needRequest) {
        var hurl = {
            url: `https://free-api.heweather.net/s6/weather/lifestyle?location=${config.lat_lon}&key=${config.heweather_apiKey}`,
        };
